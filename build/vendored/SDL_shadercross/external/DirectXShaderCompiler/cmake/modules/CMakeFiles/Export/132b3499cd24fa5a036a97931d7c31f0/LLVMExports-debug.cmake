...
set_target_properties(LLVMSupport PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMSupportd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMSupport )
list(APPEND _cmake_import_check_files_for_LLVMSupport "${_IMPORT_PREFIX}/lib/LLVMSupportd.lib" )
...
set_target_properties(LLVMMSSupport PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMMSSupportd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMMSSupport )
list(APPEND _cmake_import_check_files_for_LLVMMSSupport "${_IMPORT_PREFIX}/lib/LLVMMSSupportd.lib" )
...
set_target_properties(LLVMTableGen PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMTableGend.lib"
  )

list(APPEND _cmake_import_check_targets LLVMTableGen )
list(APPEND _cmake_import_check_files_for_LLVMTableGen "${_IMPORT_PREFIX}/lib/LLVMTableGend.lib" )
...
set_target_properties(LLVMCore PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMCored.lib"
  )

list(APPEND _cmake_import_check_targets LLVMCore )
list(APPEND _cmake_import_check_files_for_LLVMCore "${_IMPORT_PREFIX}/lib/LLVMCored.lib" )
...
set_target_properties(LLVMIRReader PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMIRReaderd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMIRReader )
list(APPEND _cmake_import_check_files_for_LLVMIRReader "${_IMPORT_PREFIX}/lib/LLVMIRReaderd.lib" )
...
set_target_properties(LLVMBitReader PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMBitReaderd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMBitReader )
list(APPEND _cmake_import_check_files_for_LLVMBitReader "${_IMPORT_PREFIX}/lib/LLVMBitReaderd.lib" )
...
set_target_properties(LLVMBitWriter PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMBitWriterd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMBitWriter )
list(APPEND _cmake_import_check_files_for_LLVMBitWriter "${_IMPORT_PREFIX}/lib/LLVMBitWriterd.lib" )
...
set_target_properties(LLVMTransformUtils PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMTransformUtilsd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMTransformUtils )
list(APPEND _cmake_import_check_files_for_LLVMTransformUtils "${_IMPORT_PREFIX}/lib/LLVMTransformUtilsd.lib" )
...
set_target_properties(LLVMInstCombine PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMInstCombined.lib"
  )

list(APPEND _cmake_import_check_targets LLVMInstCombine )
list(APPEND _cmake_import_check_files_for_LLVMInstCombine "${_IMPORT_PREFIX}/lib/LLVMInstCombined.lib" )
...
set_target_properties(LLVMScalarOpts PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMScalarOptsd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMScalarOpts )
list(APPEND _cmake_import_check_files_for_LLVMScalarOpts "${_IMPORT_PREFIX}/lib/LLVMScalarOptsd.lib" )
...
set_target_properties(LLVMipo PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMipod.lib"
  )

list(APPEND _cmake_import_check_targets LLVMipo )
list(APPEND _cmake_import_check_files_for_LLVMipo "${_IMPORT_PREFIX}/lib/LLVMipod.lib" )
...
set_target_properties(LLVMVectorize PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMVectorized.lib"
  )

list(APPEND _cmake_import_check_targets LLVMVectorize )
list(APPEND _cmake_import_check_files_for_LLVMVectorize "${_IMPORT_PREFIX}/lib/LLVMVectorized.lib" )
...
set_target_properties(LLVMLinker PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMLinkerd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMLinker )
list(APPEND _cmake_import_check_files_for_LLVMLinker "${_IMPORT_PREFIX}/lib/LLVMLinkerd.lib" )
...
set_target_properties(LLVMAnalysis PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMAnalysisd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMAnalysis )
list(APPEND _cmake_import_check_files_for_LLVMAnalysis "${_IMPORT_PREFIX}/lib/LLVMAnalysisd.lib" )
...
set_target_properties(LLVMipa PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMipad.lib"
  )

list(APPEND _cmake_import_check_targets LLVMipa )
list(APPEND _cmake_import_check_files_for_LLVMipa "${_IMPORT_PREFIX}/lib/LLVMipad.lib" )
...
set_target_properties(LLVMOption PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMOptiond.lib"
  )

list(APPEND _cmake_import_check_targets LLVMOption )
list(APPEND _cmake_import_check_files_for_LLVMOption "${_IMPORT_PREFIX}/lib/LLVMOptiond.lib" )
...
set_target_properties(LLVMTarget PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMTargetd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMTarget )
list(APPEND _cmake_import_check_files_for_LLVMTarget "${_IMPORT_PREFIX}/lib/LLVMTargetd.lib" )
...
set_target_properties(LLVMAsmParser PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMAsmParserd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMAsmParser )
list(APPEND _cmake_import_check_files_for_LLVMAsmParser "${_IMPORT_PREFIX}/lib/LLVMAsmParserd.lib" )
...
set_target_properties(LLVMProfileData PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMProfileDatad.lib"
  )

list(APPEND _cmake_import_check_targets LLVMProfileData )
list(APPEND _cmake_import_check_files_for_LLVMProfileData "${_IMPORT_PREFIX}/lib/LLVMProfileDatad.lib" )
...
set_target_properties(LLVMPasses PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMPassesd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMPasses )
list(APPEND _cmake_import_check_files_for_LLVMPasses "${_IMPORT_PREFIX}/lib/LLVMPassesd.lib" )
...
set_target_properties(LLVMPassPrinters PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMPassPrintersd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMPassPrinters )
list(APPEND _cmake_import_check_files_for_LLVMPassPrinters "${_IMPORT_PREFIX}/lib/LLVMPassPrintersd.lib" )
...
set_target_properties(LLVMDxcSupport PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMDxcSupportd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMDxcSupport )
list(APPEND _cmake_import_check_files_for_LLVMDxcSupport "${_IMPORT_PREFIX}/lib/LLVMDxcSupportd.lib" )
...
set_target_properties(LLVMHLSL PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMHLSLd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMHLSL )
list(APPEND _cmake_import_check_files_for_LLVMHLSL "${_IMPORT_PREFIX}/lib/LLVMHLSLd.lib" )
...
set_target_properties(LLVMDXIL PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMDXILd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMDXIL )
list(APPEND _cmake_import_check_files_for_LLVMDXIL "${_IMPORT_PREFIX}/lib/LLVMDXILd.lib" )
...
set_target_properties(LLVMDxilContainer PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMDxilContainerd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMDxilContainer )
list(APPEND _cmake_import_check_files_for_LLVMDxilContainer "${_IMPORT_PREFIX}/lib/LLVMDxilContainerd.lib" )
...
set_target_properties(LLVMDxilHash PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMDxilHashd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMDxilHash )
list(APPEND _cmake_import_check_files_for_LLVMDxilHash "${_IMPORT_PREFIX}/lib/LLVMDxilHashd.lib" )
...
set_target_properties(LLVMDxilPdbInfo PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMDxilPdbInfod.lib"
  )

list(APPEND _cmake_import_check_targets LLVMDxilPdbInfo )
list(APPEND _cmake_import_check_files_for_LLVMDxilPdbInfo "${_IMPORT_PREFIX}/lib/LLVMDxilPdbInfod.lib" )
...
set_target_properties(LLVMDxilPIXPasses PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMDxilPIXPassesd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMDxilPIXPasses )
list(APPEND _cmake_import_check_files_for_LLVMDxilPIXPasses "${_IMPORT_PREFIX}/lib/LLVMDxilPIXPassesd.lib" )
...
set_target_properties(LLVMDxilDia PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMDxilDiad.lib"
  )

list(APPEND _cmake_import_check_targets LLVMDxilDia )
list(APPEND _cmake_import_check_files_for_LLVMDxilDia "${_IMPORT_PREFIX}/lib/LLVMDxilDiad.lib" )
...
set_target_properties(LLVMDxilRootSignature PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMDxilRootSignatured.lib"
  )

list(APPEND _cmake_import_check_targets LLVMDxilRootSignature )
list(APPEND _cmake_import_check_files_for_LLVMDxilRootSignature "${_IMPORT_PREFIX}/lib/LLVMDxilRootSignatured.lib" )
...
set_target_properties(LLVMDxilValidation PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMDxilValidationd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMDxilValidation )
list(APPEND _cmake_import_check_files_for_LLVMDxilValidation "${_IMPORT_PREFIX}/lib/LLVMDxilValidationd.lib" )
...
set_target_properties(LLVMDxcBindingTable PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMDxcBindingTabled.lib"
  )

list(APPEND _cmake_import_check_targets LLVMDxcBindingTable )
list(APPEND _cmake_import_check_files_for_LLVMDxcBindingTable "${_IMPORT_PREFIX}/lib/LLVMDxcBindingTabled.lib" )
...
set_target_properties(LLVMDxrFallback PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMDxrFallbackd.lib"
  )

list(APPEND _cmake_import_check_targets LLVMDxrFallback )
list(APPEND _cmake_import_check_files_for_LLVMDxrFallback "${_IMPORT_PREFIX}/lib/LLVMDxrFallbackd.lib" )
...
set_target_properties(LLVMDxilCompression PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C;CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/LLVMDxilCompressiond.lib"
  )

list(APPEND _cmake_import_check_targets LLVMDxilCompression )
list(APPEND _cmake_import_check_files_for_LLVMDxilCompression "${_IMPORT_PREFIX}/lib/LLVMDxilCompressiond.lib" )
...
set_target_properties(DxilConvPasses PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/DxilConvPassesd.lib"
  )

list(APPEND _cmake_import_check_targets DxilConvPasses )
list(APPEND _cmake_import_check_files_for_DxilConvPasses "${_IMPORT_PREFIX}/lib/DxilConvPassesd.lib" )
...
set_target_properties(DxbcConverter PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/DxbcConverterd.lib"
  )

list(APPEND _cmake_import_check_targets DxbcConverter )
list(APPEND _cmake_import_check_files_for_DxbcConverter "${_IMPORT_PREFIX}/lib/DxbcConverterd.lib" )
...
set_target_properties(ShaderBinary PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/ShaderBinaryd.lib"
  )

list(APPEND _cmake_import_check_targets ShaderBinary )
list(APPEND _cmake_import_check_files_for_ShaderBinary "${_IMPORT_PREFIX}/lib/ShaderBinaryd.lib" )
...
set_target_properties(dxilconv PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/dxilconvd.dll"
  )

list(APPEND _cmake_import_check_targets dxilconv )
list(APPEND _cmake_import_check_files_for_dxilconv "${_IMPORT_PREFIX}/lib/dxilconvd.dll" )
...
set_target_properties(dxexp PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dxexp.exe"
  )
