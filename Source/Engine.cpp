...
#include "Editor/ProjectSelector/ProjectSelector.hpp"
#include "Editor/ProjectLoader/ProjectLoader.hpp"
...
Engine::Engine() {
    ...
    SDL_Log(currentPath.string().c_str());
...
int Engine::Run() {
    ...
    mogusMat->normal = AssetLoader::Get().ImportTexture("Content/mogus/textures/normal.png");
